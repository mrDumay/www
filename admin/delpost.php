 ...
 *   email                : zcinc@mail.ru
 *
 *   $Id: delpost.php,v 2.17.0.1 2005/03/1  Exp $
 *
 *
 ***************************************************************************/
 ...
 ***************************************************************************/
 ...
 $query_author = "DELETE FROM guestbook_authors WHERE id_post=".$_GET['id_post'];
 if(mysql_query($query_author)) {
 	$query_post = "DELETE FROM guestbook_posts WHERE id_post=".$_GET['id_post'];
