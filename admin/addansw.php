 ...
 *   email                : zcinc@mail.ru
 *
 *   $Id: addansw.php,v 2.17.0.1 2005/03/1  Exp $
 *
 *
 ***************************************************************************/
 ...
 ***************************************************************************/
 ...
 $query_post = "UPDATE guestbook_posts SET 
 					post_answer='".$_POST['post_answer']."', 
					post_body='".$_POST['post_body']."' WHERE 
 ...
 if(mysql_query($query_post)) {
    ...
    print "</HEAD></HTML>\n";
 	...
 	puterror("Произошла ошибка при добавлении ответа");
 }		 
?>
<?php
/***************************************************************************
